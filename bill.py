...
def total(unit , fixed_rate , fixed_charges):
    # fixed_rate = rate per unit.
    # fixed_charges = energy transfer rate per unit.
   

    output =  116 + (fixed_rate * unit) + (1.17 * unit) + (fixed_charges * unit) 
